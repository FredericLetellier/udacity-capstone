...
public class EventValues {
    ...
    public static ContentValues from(Event event) {
        ...
        values.put(EventPersistenceContract.EventEntry.COLUMN_NAME_TIMESTAMP, event.getTimestamp());
        values.put(EventPersistenceContract.EventEntry.COLUMN_NAME_BARCODE, event.getBarcode());
        values.put(EventPersistenceContract.EventEntry.COLUMN_NAME_STATUS, event.getStatus());
        return values;
    }
}
