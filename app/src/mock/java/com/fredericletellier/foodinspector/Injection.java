...
import com.fredericletellier.foodinspector.data.source.local.CategoryLocalDataSource;
import com.fredericletellier.foodinspector.data.source.local.CategoryTagLocalDataSource;
import com.fredericletellier.foodinspector.data.source.local.CountryCategoryLocalDataSource;
import com.fredericletellier.foodinspector.data.source.local.EventLocalDataSource;
import com.fredericletellier.foodinspector.data.source.local.ProductLocalDataSource;
import com.fredericletellier.foodinspector.data.source.local.SuggestionLocalDataSource;
